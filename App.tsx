        ...
        <section id="download" className="relative py-24 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
               {/* App Store Button - Linked */}
               <a 
                 href="https://apps.apple.com/hk/app/studyx/id6752533319?l=en-GB" 
                 target="_blank" 
                 rel="noopener noreferrer"
                 className="flex items-center gap-3 bg-white text-gray-900 px-5 py-2.5 rounded-lg border border-gray-200 hover:bg-gray-50 hover:scale-105 transition-all duration-300 shadow-xl min-w-[180px]"
               >
