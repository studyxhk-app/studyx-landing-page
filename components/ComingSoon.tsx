    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      <div className="max-w-xl w-full relative z-10">
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 p-8 md:p-12 text-center animate-in fade-in zoom-in duration-500">
          ...
          <div className="mb-10">
             <a 
               href="https://apps.apple.com/hk/app/studyx/id6752533319?l=en-GB" 
               target="_blank" 
               rel="noopener noreferrer"
               className="inline-flex items-center gap-3 bg-black text-white px-6 py-3.5 rounded-xl hover:scale-105 transition-all duration-300 shadow-lg"
             >
                ...
                <div className="text-left flex flex-col items-start">
                  <span className="text-[10px] font-medium leading-none mb-1 uppercase text-gray-300">{t('cta.downloadon')}</span>
                  <span className="text-xl font-bold leading-none font-sans tracking-tight">{t('cta.appstore')}</span>
                </div>
             </a>
             <p className="mt-4 text-xs text-gray-500">
               {t('coming.android_beta')}
             </p>
          </div>
